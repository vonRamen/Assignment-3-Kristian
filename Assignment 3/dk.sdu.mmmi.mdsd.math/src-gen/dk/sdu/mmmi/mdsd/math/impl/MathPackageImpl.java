...
public class MathPackageImpl extends EPackageImpl implements MathPackage
{
   ...
   */
  @Override
  public EReference getProgram_ExternalDeclarations()
  {
   ...
   */
  @Override
  public EAttribute getExternalDeclaration_TypeParameters()
  {
   ...
   */
  @Override
  public EReference getExternalCall_Function()
  {
   ...
   */
  @Override
  public EReference getExternalCall_Expressions()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(programEClass, PROGRAM__EXTERNAL_DECLARATIONS);
    ...
    createEAttribute(externalDeclarationEClass, EXTERNAL_DECLARATION__TYPE_PARAMETERS);
    ...
    createEReference(externalCallEClass, EXTERNAL_CALL__FUNCTION);
    createEReference(externalCallEClass, EXTERNAL_CALL__EXPRESSIONS);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getProgram_ExternalDeclarations(), this.getExternalDeclaration(), null, "externalDeclarations", null, 0, -1, Program.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getProgram_Exp(), this.getMathExp(), null, "exp", null, 0, 1, Program.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getExternalDeclaration_TypeParameters(), ecorePackage.getEString(), "typeParameters", null, 0, -1, ExternalDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getExternalCall_Function(), this.getExternalDeclaration(), null, "function", null, 0, 1, ExternalCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getExternalCall_Expressions(), this.getExpression(), null, "expressions", null, 0, -1, ExternalCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
