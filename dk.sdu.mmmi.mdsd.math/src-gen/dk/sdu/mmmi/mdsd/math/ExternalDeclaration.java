 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.math.ExternalDeclaration#getTypeParameters <em>Type Parameters</em>}</li>
 * </ul>
 *
...
public interface ExternalDeclaration extends EObject
{
   ...
   * @see dk.sdu.mmmi.mdsd.math.MathPackage#getExternalDeclaration_TypeParameters()
   * @model unique="false"
   * @generated
   */
